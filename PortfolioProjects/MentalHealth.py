    ...
    while True:
        ...
        match choice:
            case "1":
                ...
                slow_print("You feel a little better, but the anxiety is still there.")
                break
            case "2":
                slow_print("You decide to avoid the presentation altogether.")
                player_stats["Energy"] -= 1
                slow_print("You lose a point of energy. You still have to do that presentation!")
                break
            case "3":
                slow_print("You practice your speech in front of a mirror.")
                player_stats["Energy"] += 2
                slow_print("You feel more confident and ready to face the audience.")
                break
            case _:
    ...
    while True:
        ...
        match choice:
            case "1":
                ...
                player_stats["Energy"] -= 2
                slow_print("You feel even more overwhelmed.")
                break
                
            case "2":
                slow_print("You make a to-do list and tackle one task at a time.")
                player_stats["Energy"] += 2
                slow_print("You feel more organized and less stressed.")
                break
            case "3":
                slow_print("You ask for help from a colleague.")
                player_stats["Energy"] += 1
                slow_print("You feel supported and less stressed.")
                break
            case _:
                slow_print("Invalid choice. Please try again.")
                choice = input("What do you do?")
